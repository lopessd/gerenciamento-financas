...
export default function CofreDiarioPage() {
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Cofre Diário</h1>
              <p className="text-muted-foreground">Controle de movimentações financeiras diárias</p>
            </div>
          </div>
